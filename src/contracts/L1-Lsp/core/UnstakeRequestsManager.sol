...
import {IOracleReadRecord} from "@/contracts/L1-Lsp/interfaces/IOracle.sol";
import {
    IUnstakeRequestsManager,
    IUnstakeRequestsManagerWrite,
    IUnstakeRequestsManagerRead,
    UnstakeRequest
} from "@/contracts/L1-Lsp/interfaces/IUnstakeRequestsManager.sol";


import {BaseApp} from "@/contracts/L1-Lsp/core/BaseApp.sol";

import {IStakingReturnsWrite} from "@/contracts/L1-Lsp/interfaces/IStaking.sol";
...
interface UnstakeRequestsManagerEvents {
    ...
    /// @param dETHLocked The amount of dETH that will be burned when the request is claimed.
    ...
    ProtocolEvents
{
    ...
    function claim(uint256 requestID, address requester) external onlyStakingContract {
        ...
        // Claiming the request burns the locked dETH tokens from this contract.
    ...
    function cancelUnfinalizedRequests(uint256 maxCancel) external onlyRole(REQUEST_CANCELLER_ROLE) returns (bool) {
        ...
        // Return the locked dETH of all cancelled requests.
