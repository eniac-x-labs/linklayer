...
import {Staking} from "@/contracts/L1-Lsp/core/Staking.sol";
...
/// @param dETHLocked The amount of dETH that was locked when the unstake request was created. The amount of dETH
...
interface IUnstakeRequestsManagerWrite {
    ...
    /// @param dETHLocked The amount of dETH tokens currently locked in the contract.
